        ...
        <div class="box-body">
            @if($selected == 1)
                ...
                <div class ="form-group">
                    ...
                    <div class="col-xs-4">
                        <label class ="control-label"><h3><b><u>Add New Question</u></b></h3></label>
                    </div>
                </div>
                <div class ="form-group">
                ...
                <div class ="form-group">
                    ...
                    <div class="col-xs-4">
                        <select class="form-control" name="chapter_no">
                            <option value="" name="" selected disabled>Select Chapter</option>
        ...
        <div class="box-body">
            <table id="example2" class="table table-bordered table-hover">
                ...
                @if($questions != null)
                    ...
                    @foreach($questions as $question)
                        <tr>
                            ...
                            <td>{{isset($question)?$question->chapter_no." - ".$question->chapter->chapter_name:""}}</td>
                ...
                <div class="btn-group-vertical">
                    <a href="{{route('lecturerQuestionOperation.show', $question->question_id)}}" class="btn btn-primary btn-block btn-flat">View Question</a>
