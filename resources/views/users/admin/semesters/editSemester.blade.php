...
@endif
    {!! Form::model($semesterSelected, array(
                          'method' => 'patch',
                          'class' => 'form-horizontal',
                          'route' => ['semesterOperation.update', $semesterSelected->semester_id]

                      )) !!}
<!-- Default box -->
    <div class="box">
        <div class="box-header">
            <center><h3>Edit <b>{{$semesterSelected->semester}}</b></h3></center>
        </div>
        <div class="box-body">
            <div class ="form-group">
                <label class ="col-sm-4 control-label">* Semester Name:</label>
                <div class="col-xs-4">
                    {!! Form::text('semester_name', $semesterSelected->semester, array('class' => 'form-control')) !!}
                </div>
            </div>
            <div class ="form-group">
                <label class ="col-sm-4 control-label">* Start Date:</label>
                <div class="col-xs-4">
                    {!! Form::date('start_date', $semesterSelected->start, array('class' => 'form-control')) !!}
                </div>
            </div>
            <div class ="form-group">
                <label class ="col-sm-4 control-label">* End Date:</label>
                <div class="col-xs-4">
                    {!! Form::date('end_date', $semesterSelected->end, array('class' => 'form-control')) !!}
                </div>
            </div>
            <div class ="form-group">
                ...
                <div class="col-xs-2">
                    ...
                    {!! Form::submit('Update', array('class' => 'btn btn-primary btn-block btn-flat')) !!}
                </div>
            </div>
            {!! Form::close() !!}
        </div>
