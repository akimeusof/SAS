...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <center>
                <h3>Edit Assessment's <b>Open Date</b></h3>
            </center>
        </div>
        <div class="box-body">
            {!!
              Form::open(array('class' => 'form-horizontal',
                'route' => ['l_updateAssessmentOpenDate', $assessment->assessment_id]))
            !!}
            ...
            <div class ="form-group">
                <label class ="col-sm-4 control-label"><h4><b>Current Open Date:</b></h4></label>
                <div class="col-xs-4">
                    <label class ="control-label">
                        <h4><b>{{$assessment->start}}</b></h4>
                    </label>
                </div>
            </div>
            <div class ="form-group">
                ...
                <div class="col-xs-4">
                    {!! Form::date('open_date', null, array('class' => 'form-control')) !!}
                </div>
            </div>
            <div class ="form-group">
